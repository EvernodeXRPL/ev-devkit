...
async function bundleContract(contractDirectoryPath, unl, contractBin, contractArgs = "", peers = [], contractConfig = {}, prerequisite = PREREQ_SCRIPT_CONTENT) {
    ...
    fs.writeFileSync(hpCfgOverridePath, JSON.stringify(overrideCfg, null, 4));
