...
class EvernodeManager {
    ...
    constructor(options = {}) {
        this.#governorAddress = options.governorAddress || 'raVhw4Q8FQr296jdaDLDfZ4JDhh7tFG7SF';
    ...
    async acquire(moments, ownerPubkey, hostAddress = null, contractId = uuid.v4(), instanceImage = "evernodedev/sashimono:hp.0.6.1-ubt.20.04-njs.16", config = {}, options = {}) {
        if (!this.#tenantClient)
