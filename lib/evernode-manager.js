...
class EvernodeManager {
    ...
    async acquire(moments, ownerPubkey, hostAddress = null, contractId = uuid.v4(), instanceImage = "evernodedev/sashimono:hp.latest-ubt.20.04-njs.16", config = {}, options = {}) {
        if (!this.#tenantClient)
