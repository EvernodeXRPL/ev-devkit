...
async function audit(options) {
    ...
    try {
        ...
        const AuditResult = (hostAddress, auditSuccess, timeAcquire = defaultValue, timeReadRequestResponse = defaultValue, timeContractResponse = defaultValue, hpVersion = defaultValue, ledgerSeqNo = defaultValue, roundTime = defaultValue, errorMessage = defaultValue) => {
            return {
        ...
        for (let hostIndex in hostsToAudit) {
            ...
            try {
                ...
                auditResults.push(AuditResult(hostAddress, auditSuccess, timeAcquire, timeReadRequestResponse, timeContractResponse, hpVersion, ledgerSeqNo, roundTime, errorMessage));
                if (instanceMgr)
