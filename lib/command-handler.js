...
async function audit(options) {
    ...
    try {
        ...
        function AuditResult(hostAddress, auditSuccess, timeAcquire = defaultValue, timeContractResponse = defaultValue, hpVersion = defaultValue, ledgerSeqNo = defaultValue, roundTime = defaultValue) {
            return {
        ...
        for (hostIndex in hostsToAudit) {
            ...
            let timeAcquire, timeContractResponse, hpVersion, ledgerSeqNo, roundTime, auditSuccess;
            try {
                ...
                auditResults.push(new AuditResult(hostAddress, auditSuccess, timeAcquire, timeContractResponse, hpVersion, ledgerSeqNo, roundTime));
            }
        }
    }
    catch (e) {
