...
async function clusterCreate(size, contractDirectoryPath, contractBin, hostsFilePath, evrLimit, options) {
    ...
    try {
        ...
        const result = await clusterMgr.createCluster(hostsFilePath, evrLimit);
